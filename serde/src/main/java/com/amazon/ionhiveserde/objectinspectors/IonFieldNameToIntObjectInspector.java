...
public class IonFieldNameToIntObjectInspector
    ...
    protected Integer getValidatedPrimitiveJavaObject(final String fieldName) {
        return Integer.parseInt(getPrimitiveWritableObject(fieldName));
    }

    @Override
    protected void validateSize(final String fieldName) {
        try {
            Integer intValue = Integer.parseInt(getPrimitiveWritableObject(fieldName));
    ...
    public Object getPrimitiveJavaObject(final Object o) {
        ...
        return Integer.parseInt(getPrimitiveWritableObject(o.toString()));
    }

    @Override
    public Object getPrimitiveWritableObject(final Object o) {
        // TODO: Verify if field name can be null
        return new IntWritable(Integer.parseInt(o.toString()));
    }

    private String getPrimitiveWritableObject(final String ionValue) {
        return ionValue;
    }
}